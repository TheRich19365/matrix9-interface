...
import { CircleAlert, Copy, ExternalLink, Mail } from "lucide-react";
import { contactLinks, isConfiguredEmail, isConfiguredUrl, isEnabledLink } from "../data/contactLinks.js";

export function LineAction({ onCopyLine, copied, className = "", children = "คัดลอก LINE ID" }) {
